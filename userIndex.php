...
if ($pdo && !$db_error) {
    try {
        ...
        // FIXED: Get cart count from database
        ...
        $debug_info[] = " Cart items: " . $cartCount;
...
<body>
    ...
    <script>
        ...
        // FIXED: Update cart count from database via AJAX
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // FIXED: Update cart count from database on load
            updateCartCount();
